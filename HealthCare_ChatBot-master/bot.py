...
# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open('..\Data Science\Projects\HealthCare_ChatBot-master\chatbot_modelsave','rb'))
model,second_le  = pk.load(open('..\Data Science\Projects\HealthCare_ChatBot-master\chatbot_model','rb'))
ners = pk.load(open('..\Data Science\Projects\HealthCare_ChatBot-master\newsave_model','rb'))

# Load NN Model 
FILE = "..\Data Science\Projects\HealthCare_ChatBot-master\data.pth"
